function user_job_setup()
	...
	state.JugMode = M{['description']='Jug Mode', 'ScissorlegXerin','BlackbeardRandy','CourierCarrie','AttentiveIbuki','DroopyDortwin','WarlikePatrick','AcuexFamiliar'}
	...
	--Example of how to change default ready moves.
		ready_moves.default.BlackbeardRandy = 'Razor Fang'
...
function init_gear_sets()
	...
	sets.midcast.Pet.WS = {main=gear.PHYKumbha1,sub=gear.PHYKumbha2,ammo="Voluspa Tathlum",
		...
		body="Taeon Tabard",hands="Nukumi Manoplas",ring1="Varar Ring +1",ring2="C. Palug Ring",
	...
	sets.engaged = {
--	main="Izizoeksi",ammo="Aurgelmir Orb +1",
