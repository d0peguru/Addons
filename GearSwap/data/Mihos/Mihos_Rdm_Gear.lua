function user_job_setup()
	...
	state.Weapons:options('None','Naegling','SwordNSheild','Crocea','BowMacc','EnspellOnly')
	
-- 'Naegling','Sequence','DualWeapons','DualWeaponsAcc','DualEvisceration','DualClubs','DualAeolian','DualProcDaggers','EnspellOnly'
	...
	gear.Chironic_MAB = { name="Chironic Hose", augments={'DEX+8','Pet: INT+3','Magic Damage +10','Accuracy+20 Attack+20','Mag. Acc.+19 "Mag.Atk.Bns."+19',}}
	...
	send_command('bind !delete input /ja "Penury" <me>')
	send_command('bind @delete input /ja "Parsimony" <me>')
	...
	send_command('bind @q gs c set weapons none')
...
--		back=gear.wsd_jse_back,waist="Windbuffet Belt +1",legs="Carmine Cuisses +1",feet="Carmine Greaves +1"
	...
	sets.precast.WS['Savage Blade'] = {range=empty,ammo="Regal Gem",
		...
		back=gear.wsd_jse_back,waist="Sailfi Belt +1",legs=Chironic_WSD,feet="Jhakri Pigaches +2"}
	...
	sets.precast.WS['Seraph Blade'] = {range=empty,ammo="Pemphredo Tathlum",
		head="Bunzi's Hat",neck="Baetyl Pendant",ear1="Moonshade Earring",ear2="Malignance Earring",
		body="Nyame Mail",hands="Jhakri Cuffs +2",ring1="Shiva Ring +1",ring2="Freke Ring",
		back=gear.nuke_jse_back,waist="Refoccilation Stone",legs="Nayme Flanchard",feet="Nayme Sollerets"}
    ...
    sets.MagicBurst = {
			main=gear.grioavolr_nuke_staff,sub="Alber Strap",
			head="Ea Hat +1",
...
--      back="Tempered Cape +1",waist="Luminary Sash",legs="Carmine Cuisses +1",feet="Kaykaus Boots"
	...
	sets.Self_Refresh = {head="Amalric Coif +1",legs="Lethargy Fuseau +1",body="Atrophy Tabard +2",back="Grapevine Cape",waist="Gishdubar Sash",feet="Inspirited Boots"}
	...
	sets.midcast.Refresh = {head="Amalric Coif +1",body="Atrophy Tabard +3",legs="Leth. Fuseau +1",boots="Inspirited Boots"}
	...
	sets.midcast['Enfeebling Magic'] = {
		main="Daybreak",sub="Ammurapi Shield",range=empty,
		ammo="Regal Gem",
		...
		back=gear.nuke_jse_back,waist="Luminary Sash",legs=Chironic_MAB,feet="Vitiation Boots +3"
		}
...
--		head="Viti. Chapeau +3",neck="Dls. Torque +2",ear1="Regal Earring",ear2="Snotra Earring",
--		body="Amalric doublet +1",hands=gear.chironic_enfeeble_hands,ring1="Metamor. Ring +1",ring2="Stikini Ring +1",
--		back=gear.nuke_jse_back,waist="Luminary Sash",legs="Chironic Hose",feet="Vitiation Boots +3"
    ...
    sets.midcast['Elemental Magic'] = {
			...
			feet={ name="Merlinic Crackows", augments={'Mag. Acc.+25 "Mag.Atk.Bns."+25','Magic burst dmg.+3%','INT+2','Mag. Acc.+11','"Mag.Atk.Bns."+14',}},
			neck="Baetyl Pendant",
...
--		back=gear.nuke_jse_back,waist=gear.ElementalObi,legs="Merlinic Shalwar",feet=gear.merlinic_nuke_feet
    ...
    sets.midcast.Drain = {main="Rubicundity",sub="Ammurapi Shield",range="Kaja Bow",ammo=empty,
        ...
        back=gear.nuke_jse_back,waist="Fucho-no-obi",legs=Chironic_MAB,feet=gear.merlinic_aspir_feet}
	...
	sets.midcast.Stun = {main="Daybreak",sub="Ammurapi Shield",range="Kaja Bow",ammo=empty,
		...
		back=gear.nuke_jse_back,waist="Sailfi Belt +1",legs=Chironic_MAB,feet=gear.merlinic_aspir_feet}
	...
	sets.midcast.Stun.Resistant = {main="Daybreak",sub="Ammurapi Shield",range="Kaja Bow",ammo=empty,
		...
		back=gear.nuke_jse_back,waist="Acuity Belt +1",legs=Chironic_MAB,feet=gear.merlinic_aspir_feet}
...
--		back="Umbra Cape",waist="Flume Belt +1",legs="Lengo Pants",feet=gear.merlinic_refresh_feet
	...
	sets.idle.PDT = {
		...
		back="Moonlight Cape",waist="Windbuffet Belt +1",legs="Nyame Flanchard",feet="Nyame Sollerets"
...
--		back="Moonlight Cape",waist="Flume Belt +1",legs="Malignance Tights",feet="Malignance Boots"
	...
	sets.defense.PDT = {
		...
		main="Sakpata's Sword",sub="Umbra Strap",range=empty,ammo="Staunch Tathlum +1",
...
--	sets.weapons.Sequence = {main="Sequence",sub="Ammurapi Shield"}
	sets.weapons.SwordNSheild = {main="Naegling",sub="Ammurapi Shield"}
	...
	sets.weapons.EnspellOnly = {main="Qutrub Knife",sub="Yagyu Shortblade",range="Kaja Bow",ammo="Beetle Arrow"}
	...
	sets.weapons.BowMacc = {main="Naegling",sub="Ammurapi Shield",range="Kaja Bow",ammo=empty}
	sets.weapons.Naegling = {main="Naegling",sub="Thibron"}	
	sets.weapons.Crocea = {main="Crocea Mors",sub="Thibron"}
...
--		back=gear.stp_jse_back,waist="Windbuffet Belt +1",legs="Malignance Tights",feet="Carmine Greaves +1"
	...
	sets.engaged.EnspellOnly = {
		head="Taeon Chapeau",neck="Dls. Torque +2",ear1="Suppanomimi",ear2="Digni. Earring",
	...
	if player.sub_job == 'NIN' or player.sub_job == 'DNC' then
		...
		elseif res.items[item_name_to_id(player.equipment.main)].skill == 11 then --Club in main hand.
			...
			elseif res.items[item_name_to_id(player.equipment.sub)].skill == 11 then --Club/Club.
				...
				windower.chat.input('/lockstyleset 024') --Catchall
			end
		end
