...
function check_shadows()
	...
	if player.main_job == 'NIN' then
		if currentshadows < 2 and player.job_points[(res.jobs[player.main_job_id].ens):lower()].jp_spent > 99 and spell_recasts[340] < spell_latency then
			windower.chat.input('/ma "Utsusemi: San" <me>')
			tickdelay = os.clock() + 1.8
			return true
		elseif currentshadows < 1 then
